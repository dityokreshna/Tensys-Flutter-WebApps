...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    Stream<QuerySnapshot> historyReference = FirebaseFirestore.instance
        .collection("users")
        .doc("TvSl0HuLK3Zhc6CI0vWR")
        .collection("riwayat")
        .orderBy("timestamp")
        .limitToLast(15)
        .snapshots();
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, AsyncSnapshot<DocumentSnapshot> snapshot) {
        if (snapshot.hasData) {
          ...
          // var dataDenyut = int.parse(dataKu["detak"].toString());
          // var dataSistolik = int.parse(dataKu["sistolik"].toString());
          // var dataDiastolik = int.parse(dataKu["diastolik"].toString());
          ...
          //   // print(timestampKu[0]);
          //   // print(double.parse(value["detakjantung"].toString()));
              ...
              builder: (BuildContext context,
                ...
                if (snapshot.hasData) {
                  ...
                  snapshot.data!.docs.forEach((document) {
                    var timestampKu =
                        DateFormat.d().format(document.get("timestamp").toDate());                        
                    detakList.add(FlSpot(double.parse(timestampKu.toString()),
                        double.parse(document.get("denyutNadi").toString())));
                    sistolikList.add(FlSpot(
                        double.parse(timestampKu.toString()),
                        double.parse(document.get("sistolik").toString())));
                    diastolikList.add(FlSpot(
                        double.parse(timestampKu.toString()),
                        double.parse(document.get("diastolik").toString())));
                    print(document.id);
                    print(timestampKu);
                    print(document.get("timestamp"));
                  });
                  print(detakList.last.y.toString());
                   int dataDenyut = detakList.last.y.toInt();
                   int dataSistolik = sistolikList.last.y.toInt();
                   int dataDiastolik = diastolikList.last.y.toInt();
                  return detakList.isEmpty ||
                          sistolikList.isEmpty ||
                          diastolikList.isEmpty
                              ...
                              body: _selectedIndex == 0
                                  ...
                                  : _selectedIndex == 1
                                      ? HomeHistory(
                                          ...
                                          isWeb: screenSize,
                                          nilaiDetak: dataDenyut,
                                          nilaiDiastolik: dataDiastolik,
                                          nilaiSistolik: dataSistolik,
                                        )
                                      : HomeProfile(
                                          isWeb: screenSize,
                                          userName: mapName,
