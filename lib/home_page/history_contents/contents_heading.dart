...
class HistoryHeading extends StatelessWidget {
    final int nilaiDetak;
  final int nilaiSistolik;
  final int nilaiDiastolik;
  HistoryHeading({required this.nilaiDetak,required this.nilaiSistolik,required this.nilaiDiastolik});
  @override
      ...
      child: Stack(
        children: <Widget>[
          ...
          Positioned(
            ...
            left: 15,
            bottom: 0,
            child: Center(child: ProfileHeadingContent(nilaiDetak: nilaiDetak,nilaiDiastolik: nilaiDiastolik,nilaiSistolik: nilaiSistolik,)),
          )
        ],
      ),
    );
...
class ProfileHeadingContent extends StatelessWidget {
  ...
  final int nilaiSistolik;
  final int nilaiDiastolik;
  ProfileHeadingContent({required this.nilaiDetak,required this.nilaiSistolik,required this.nilaiDiastolik});
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              HeadingContent(nilai: nilaiDetak.toString(),keterangan: "Denyut Nadi",heartColor: MyColorStyle().heartBeat,),
              VerticalDivider(),
              HeadingContent(nilai: nilaiSistolik.toString(),keterangan: "Sistolik",heartColor: MyColorStyle().sistolik),
              VerticalDivider(),
              HeadingContent(nilai: nilaiDiastolik.toString(),keterangan: "Diastolik",heartColor: MyColorStyle().diastolik),
            ],
          )
        ],
      ),
