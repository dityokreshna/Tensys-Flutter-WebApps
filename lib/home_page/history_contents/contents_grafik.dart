...
class HistoryContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          _chartData(
              context, "Denyut Nadi", dataDetak, MyColorStyle().heartBeat,isWeb),
          _chartData(
              context, "Sistolik", dataSistolik, MyColorStyle().sistolik,isWeb),
          _chartData(
              context, "Diastolik", dataDiastolik, MyColorStyle().diastolik,isWeb),
        ],
      ),
    );
  }
  ...
  Container _chartData(
      context, String namaChart, List<FlSpot> dataList, Color boxColor, String screenSize) {
    return Container(
        ...
        children: [
          ...
          Container(
            ...
            child: Padding(
              ...
              child: LineChart(
                mainData(dataList, boxColor, screenSize),
              ),
            ),
          ),
        ],
  ...
  LineChartData mainData(List<FlSpot> dataList, Color myColor, String screenSize) {
    double myx =  dataList.first.x;
    double myxmin = dataList.first.x;
    ...
    return LineChartData(
      ...
      minX:myxmin - 1,
      maxX:myx, 
      // screenSize == "small" ? myx : screenSize == "mid" ? myx : 32,
      minY: 0,
      maxY: 200,
      lineBarsData: [
        LineChartBarData(
