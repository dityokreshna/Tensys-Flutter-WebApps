...
class HomeHistory extends StatelessWidget {
  ...
  HomeHistory(
      ...
      required this.isWeb,
      required this.nilaiDetak,
      required this.nilaiSistolik,
      required this.nilaiDiastolik
      });
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            HistoryHeading(nilaiDetak: nilaiDetak,nilaiDiastolik: nilaiDiastolik,nilaiSistolik: nilaiSistolik,),
            Container(
